...
For our K-means model, we used all of the quantitative parameters to predict weather type, as in our KNN model. This K- model for weather type is less accurate, as can be seen with the table. 
## K-means
```{r}
library(fpc)
library(flexclust)
