...
weather.lst <- lapply(data.df[ , c(3,4,5,8)], normalize.it)
data.weather.normed <- data.frame(weather.lst)
summary(data.weather.normed)
...
pressure.ts <- ts(pressure.vec[7000:7100], frequency = 8760)
plot.ts(pressure.ts, main = "Pressure Time Series Graph", ylab = "Pressure")
```
