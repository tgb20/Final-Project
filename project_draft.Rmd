...
true.label.temp <- data.df$temp[test.row.nums]
num.incorrect.labels.temp <- sum(weather.pred2 != true.labels.temp)
misc.rate.temp <- num.incorrect.labels.temp/num.test.labels
misc.rate.temp
